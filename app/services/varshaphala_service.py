...
class VarshaphalaService:
    ...
    def calculate_annual_chart(req: VarshaphalaRequest) -> VarshaphalaResponse:
        ...
        return VarshaphalaResponse(target_year=res["target_year"], solar_return_date=res["solar_return_date"], varsha_ascendant=res["varsha_ascendant"], varsha_planets=res["varsha_planets"], muntha=res["muntha"], varsheshwara=res["varsheshwara"], tajika_yogas=res["tajika_yogas"])
